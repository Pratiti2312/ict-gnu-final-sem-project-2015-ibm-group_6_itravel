...
public class map_activity extends FragmentActivity implements OnMapReadyCallback,
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng india = new LatLng(22.979720, 72.618960);
        mMap.addMarker(new MarkerOptions().position(india).title("Ganesh Meridian"));
    ...
    public void onClick(View view)
    {
        switch (view.getId())
        {
            ...
            case R.id.B_hospital:
                ...
                Toast.makeText(map_activity.this, "Showing nearby Offices", Toast.LENGTH_LONG).show() ;
                break;
    ...
    private String getDirectionsUrl()
    {
     ...
     private  String getUrl(double latitude, double longitude, String nearbyPlace)
     {
         ...
         googlePlaceUrl.append("&key="+"AIzaSyC9Lt6E_xgcGpP0HwC0J6WAbjLpE7j5P0");
